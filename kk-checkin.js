...
async function generateHouseData(charId, includeComputer = true) {
  ...
  try {
    const { proxyUrl, apiKey, model } = window.getApiConfigForFeature ? window.getApiConfigForFeature('kkCheckin') : state.apiConfig;
...
function renderKkHouseView(houseData) {
  ...
  document.getElementById('kk-house-background').style.backgroundImage = 'none';
  document.getElementById('kk-house-background').style.backgroundColor = '#ffffff';
...
function openKkAreaView(areaName) {
  ...
  document.getElementById('kk-area-background').style.backgroundImage = 'none';
  document.getElementById('kk-area-background').style.backgroundColor = '#ffffff';
...
function renderSurveillanceView(surveillanceData) {
  ...
  for (const areaName in feeds) {
    ...
    // 使用纯白色背景
    feedEl.style.backgroundImage = 'none';
    feedEl.style.backgroundColor = '#ffffff';
